...
new_order = ["Calories", "Protein", "Fat", "Carbs", "Meal", "Course", "Healthy", "Special Nutrition", "Cooking Methods",
             "time, mins", "Vegetables", "Fruits", "Meat", "Seafood", "Mushrooms", "Dairy", "Grains",
             "Nuts"]
...
train_data[["Meal", "Course", "Special Nutrition", "Cooking Methods"]] = train_data[
    ["Meal", "Course", "Special Nutrition", "Cooking Methods"]].apply(lambda col: le_enc.fit_transform(col), axis=0)
