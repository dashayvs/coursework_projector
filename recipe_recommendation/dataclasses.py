...
@dataclass
class FilterInfo:
    CALORIES_LIMITS: Final[Range] = Range(0, 1000)  # noqa: RUF009
    PROTEINS_LIMITS: Final[Range] = Range(0, 40)  # noqa: RUF009
    FATS_LIMITS: Final[Range] = Range(0, 50)  # noqa: RUF009
    CARBS_LIMITS: Final[Range] = Range(0, 100)  # noqa: RUF009
